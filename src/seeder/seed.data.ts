...
export const SEED_PRODUCTS: Product[] = [
  ...
  },
  {
    ...
    title: 'Postre de vainilla +Proteínas (1 unidad)',
    image:
  ...
  },
  {
    ...
    fats: 12,
    presentationSize: 85,
    tags: 'pan,panecillo,queso,pancito',
    carbs: 41,
  },
  {
  ...
  },
  {
    ...
    title: 'Postre de chocolate +Proteínas (1 unidad)',
    image:
  ...
  {
    id: 'f13292c0-0f6c-4bc6-92a7-8825ajsj4ba7',
    title: 'Nata ligera',
    image:
      'https://prod-mercadona.imgix.net/images/f451d3695c8b94b17cb61540de841da8.jpg',
    calories: 163,
    fats: 15,
    carbs: 5,
    protein: 2,
    presentationSize: 200,
    tags: 'nata,ligera,hacendado,light,crema',
  },
  {
    id: 'f13292c0-abcd-4bc6-92a7-8825ajsj4ba7',
    title: 'Champiñones laminados',
    image:
      'https://prod-mercadona.imgix.net/images/4c97fc1fdefb7083f3ddfa0fd6169cb4.jpg',
    calories: 21,
    fats: 0.1,
    carbs: 1.5,
    protein: 2.8,
    presentationSize: 180,
    tags: 'champiñones,laminados,hacendado,light,champignones',
  },
  {
    id: 'f5t292c0-abcd-4bc6-92a7-8825ajsj4ba7',
    title: 'Postre de fresa +Proteínas (1 unidad)',
    image:
      'https://prod-mercadona.imgix.net/images/07f80bc46f0ec301f417a057280bedd7.jpg',
    calories: 53,
    fats: 0.5,
    carbs: 5,
    protein: 8.3,
    presentationSize: 120,
    tags: 'yogur,postre,proteina,hacendado,fresa',
  },
  {
    id: 'f5t292c0-ab99-4bc6-92a7-8c25ajsj4ba7',
    title: 'Postre de arándanos +Proteínas (1 unidad)',
    image:
      'https://prod-mercadona.imgix.net/images/43a9e33b7744d75707831d5318a8bd19.jpg',
    calories: 53,
    fats: 0.5,
    carbs: 5,
    protein: 8.3,
    presentationSize: 120,
    tags: 'yogur,postre,proteina,hacendado,arandanos',
  },
  {
    id: 'f5t292c0-ab99-4bc6-9abn-8c25ajsj4ba7',
    title: 'Aceitunas verdes rellenas de anchoa (1 lata)',
    image:
      'https://prod-mercadona.imgix.net/images/6e52471bf17d428d03899310597fa47a.jpg',
    calories: 159,
    fats: 16,
    carbs: 0,
    protein: 1.5,
...
export type MealProductCreateArgs = {
  product: string;
  quantity: number;
};

export type MealProductWithMealIdCreateArgs = MealProductCreateArgs & {
  mealId: string;
};
...
export type MealCreateArgs = {
  ...
  title: string;
  user: string;
  mealProducts: MealProductCreateArgs[];
};

export const SEED_MEALS: MealCreateArgs[] = [
  {
    id: '71850970-cab3-4bde-a715-8010159ddb12',
    title: 'Pizza de queso',
    user: '8c30a36b-6f8d-4ec6-9057-564ee9a4bdba',
    mealProducts: [
      {
        product: '04b3055b-00b7-4145-8a89-d0161678a066',
        quantity: 140,
      },
      {
        product: 'f13292c0-0f6c-4bc6-92a7-8825a6154ba7',
        quantity: 100,
      },
    ],
  },
  {
    id: '4f565417-db49-4543-9bb0-2b937ebb93bf',
    title: 'Sánguche de lomo y guacamole',
    user: '8c30a36b-6f8d-4ec6-9057-564ee9a4bdba',
    mealProducts: [
      {
        product: 'c3e979a1-d9a1-4e4b-b943-2583e7c2d278',
        quantity: 82,
      },
      {
